...
|-----------|------|----------|-------------|
| `detect_color` | string | **Required** | Target color in hex format (e.g., `"#FF0000"`). Cannot be black, white, or grayscale. |
...
```python
from viam.services.vision import VisionClient
from viam.proto.service.vision import CaptureAllFromCameraRequest

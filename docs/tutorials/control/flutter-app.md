...
If you're looking to monitor and control individual machines with the same functionality you have on the [**CONTROL** tab](/monitor/teleoperate/#web-ui), you can use the general-purpose [Viam mobile app](/monitor/teleoperate/#viam-mobile-app) rather than creating your own.

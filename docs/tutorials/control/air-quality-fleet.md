...
For more information, see [Organize your machines](/reference/account/organize/) and [Provision devices](/fleet/provision-devices/).
...
1. Add the same components that you added to the development machine when you [set up one device for development](#set-up-one-device-for-development).
   ...
   If not, you can use [fragment overwrite](/fleet/reuse-configuration/#modify-fragment-settings-on-a-machine) to modify the value on any machine for which it is different.

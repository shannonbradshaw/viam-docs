...
Use the same machine configuration from [the previous tutorial](../plan-motion-with-arm-gripper/) for this tutorial, including the [arm](/reference/components/arm/) and [gripper](/reference/components/gripper/) components with [frames](/reference/services/frame-system/) configured.

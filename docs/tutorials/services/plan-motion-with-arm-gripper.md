...
The Motion service has a method that can get the _pose_ of a component relative to a [_reference frame_](/reference/services/frame-system/).
...
This is possible because the motion service considers other components of the robot (through the [frame system](/reference/services/frame-system/)) when calculating how to achieve the desired motion.

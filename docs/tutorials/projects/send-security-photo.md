...
When someone comes to your desk, the robot will use the [vision service](/reference/services/vision/) and the [ML model service](/data-ai/ai/deploy/) to detect a person, take their photo, and text you an alert with a photo of the person.
...
If you want to train your own model instead, follow the instructions to [train a model](/train/train-a-model/) or [write custom training scripts](/train/custom-training-scripts/).

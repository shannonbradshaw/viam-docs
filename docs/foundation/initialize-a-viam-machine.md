...
- [Add a Camera](/foundation/add-a-camera/) — Configure your first hardware component and
  see a live feed.
- [Capture and Sync Data](/foundation/capture-and-sync-data/) — Start recording data from

...
1. Check whether your gripper has a kinematics file.
   ...
   Some grippers have [kinematics files](/reference/configuration/kinematic-chain-config/) that describe the position and orientation of the jaws of the gripper as they move, relative to the gripper's base.

...
to train an ML model -- you need a curated collection (a dataset) that you can
label and use for training. This how-to walks you through creating a dataset,
adding images, and verifying quality before you
[annotate](/train/annotate-images/) and train.
...
3. [Annotate your images](/train/annotate-images/) with tags or bounding boxes.

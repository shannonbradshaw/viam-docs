...
1. For each image, **Accept (A)** or **Reject (R)** each prediction.
   ...
   {{<imgproc src="/data-ai/review-ui.png" resize="1200x" class="imgzoom shadow" declaredimensions=true alt="UI for reviewing tag predictions">}}
...
1. For each image, **Accept (A)** or **Reject (R)** each prediction.
   ...
   {{<imgproc src="/data-ai/review-ui-detection.png" resize="1200x" class="imgzoom shadow" declaredimensions=true alt="UI for reviewing detection predictions">}}

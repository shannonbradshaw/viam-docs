...
aliases:
  ...
  - /reference/services/vision/color_detector/
# SMEs: Bijan, Khari
---
...
1. Configure a [camera component](/reference/components/camera/).
   {{< alert title="Tip" color="tip" >}}
...
Configure a [transform camera](/reference/components/camera/transform/) with the following attributes:

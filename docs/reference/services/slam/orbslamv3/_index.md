...
aliases:
  ...
  - /reference/services/slam/orbslamv3/
date: "2022-01-01"
...
How you configure `orbslamv3` depends on whether you want the SLAM service to build your map with data collected live by a [webcam](/reference/components/camera/) or with data provided in a dataset at runtime.
...
Running `orbslamv3` in Live Data mode requires a [webcam](/reference/components/camera/).
...
1. [Connect and configure a webcam](/reference/components/camera/webcam/)
2. [Calibrate a camera](/reference/components/camera/calibrate/)
...
| `sensors` | string[] | **Required** | Names of any configured [webcams](/reference/components/camera/) providing data to the SLAM service. |

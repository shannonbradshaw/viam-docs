...
To read compass headings, [configure a capable movement sensor](/reference/components/movement-sensor/#configuration) on your machine.
...
To read orientation, first [configure a capable movement sensor](/reference/components/movement-sensor/#configuration) on your machine.
...
To get an angular velocity reading, first [configure a capable movement sensor](/reference/components/movement-sensor/#configuration) on your machine.
...
To get a position, [configure a capable movement sensor](/reference/components/movement-sensor/#configuration) on your machine.
...
To get linear velocity, [configure a capable movement sensor](/reference/components/movement-sensor/#configuration) on your machine.
...
To get linear acceleration, [configure a capable movement sensor](/reference/components/movement-sensor/#configuration) on your machine.

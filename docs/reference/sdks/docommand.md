...
For an example that implements `DoCommand` in a generic API Python module, see [Add control logic to your module](/build-modules/write-a-logic-module/#program-control-logic-in-module).

...
- Cloud sync for the [data management service](/data/) will pause until the internet connection is re-established since the machine will be unable to connect to Viam.

...
aliases:
  ...
  - /reference/apis/components/encoder/
# updated: ""  # When the content was last entirely checked
---

The encoder API allows you to give commands to your [encoder components](/reference/components/encoder/) for getting the position of a motor or a joint in ticks or degrees.

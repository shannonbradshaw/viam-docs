...
aliases:
  ...
  - /reference/apis/components/arm/
# updated: ""  # When the content was last entirely checked
---

The arm API allows you to give commands to your [arm components](/reference/components/arm/) for linear motion planning with self-collision prevention.

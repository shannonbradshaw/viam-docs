...
The vision service enables your machine to use its on-board [cameras](/reference/components/camera/) to intelligently see and interpret the world around it.
...
The [vision service](/reference/services/vision/) supports the following methods:

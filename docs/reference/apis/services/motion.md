...
The motion service API allows you to give commands to your [motion service](/motion-planning/reference/motion-service/) for moving a mobile robot based on a SLAM map or GPS coordinates or for moving a machine's components from one pose to another.

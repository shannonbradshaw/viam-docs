...
| `model-path` | string | Optional | The path to the [kinematic configuration file](/reference/configuration/kinematic-chain-config/) of the arm driver you want your fake arm to act as. This path should point to the exact location where the file is located on your computer running `viam-server`. |

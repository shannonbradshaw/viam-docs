...
Physical sensors often require a [board component](/reference/components/board/) with a configured analog-to-digital converter (ADC).
...
- If your sensor measures GPS, IMU, position, velocity, or acceleration, use a [movement sensor](/reference/components/movement-sensor/).
- If your sensor measured voltage, current, or power consumption of connected hardware use a [power sensor](/reference/components/power-sensor/).
- If your sensor detects speed and direction of rotation of a motor or a joint, use an [encoder](/reference/components/encoder/).

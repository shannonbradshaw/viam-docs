...
If you have an industrial servo motor, configure or [create](/build-modules/write-a-driver-module/) a [motor component](/reference/components/motor/) that supports your hardware.

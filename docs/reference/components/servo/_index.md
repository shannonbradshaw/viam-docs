...
If you have an industrial servo motor, configure or [create](/operate/modules/support-hardware/) a [motor component](/reference/components/motor/) that supports your hardware.

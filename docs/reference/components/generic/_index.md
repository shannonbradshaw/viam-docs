...
If you are adding new high-level software functionality, rather than supporting new hardware components, use the [generic service](/reference/components/generic/) instead.
...
If your `viam-micro-server` machine includes a resource that isn't a [base](/reference/components/base/), [board](/reference/components/board/),[encoder](/reference/components/encoder/), [movement sensor](/reference/components/movement-sensor/), [motor](/reference/components/motor/), or [servo](/reference/components/servo/), you can create a {{< glossary_tooltip term_id="modular-resource" text="modular resource" >}} to add support for it as a custom model of the generic API.

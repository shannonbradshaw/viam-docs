...
aliases:
  ...
  - /reference/components/component/board1/
draft: true
# SMEs:
---
...
Follow the [setup guide](/reference/device-setup/board1-setup) to prepare your <model-name> to run `viam-server` before you configure your <model-name> board.

...
aliases:
  ...
  - /reference/components/input-controller/
hide_children: true
date: "2024-10-21"
# SME: James
---
...
The [base remote control service](/reference/services/base-rc/) implements an input controller as a remote control for a base.

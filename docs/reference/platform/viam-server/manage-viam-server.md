...
You can change this behavior in the [`version_control` settings of your machine](/reference/platform/viam-agent/#version_control-version-management-for-viam-agent-and-viam-server).
...
To disable automatic updates, configure the [`version_control` settings of your machine](/reference/platform/viam-agent/#version_control-version-management-for-viam-agent-and-viam-server) to a specific version number.

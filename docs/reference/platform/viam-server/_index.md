...
aliases:
  ...
  - /reference/platform/viam-server/local-configuration-file/
date: "2022-01-01"
...
- [`viam-agent` updating itself](/reference/platform/viam-agent/#version_control-version-management-for-viam-agent-and-viam-server)

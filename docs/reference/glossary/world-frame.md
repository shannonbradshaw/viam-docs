...
aliases:
  - /reference/glossary/world-frame/
  - /reference/glossary/world-frame/
---

The world reference [frame](/motion-planning/frame-system/) is the fixed, global coordinate system that serves as the reference point for all other coordinate frames in a robotic system.

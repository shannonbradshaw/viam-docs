...
type: "page"
aliases:
  - /reference/glossary/vision-service/
  - /reference/glossary/vision-service/
---
...
For more information, see the [Vision service documentation](/reference/services/vision/) or [Alert on Detections](/vision/alert-on-detections/).

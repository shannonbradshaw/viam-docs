...
- [Deploy a Module](/development/deploy-a-module/) -- package your module
  and upload it to the Viam registry for distribution.
- [Write an Inline Module](/development/write-an-inline-module/) -- if you
  need a quick prototype using the Generic component.
- [Add Computer Vision](/vision-detection/add-computer-vision/) -- build a

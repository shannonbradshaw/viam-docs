...
To rule out machine health as the root cause of your issues, [add a machine telemetry sensor](/monitor/alert/#add-performance-sensor) and [capture machine telemetry data with the data management service](/monitor/alert/#configure-data-management).

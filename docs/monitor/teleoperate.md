---
title: "Teleoperate machines remotely"
...
Like the web UI, the [Viam mobile app](/monitor/teleoperate/#viam-mobile-app) also allows you to test, monitor and remotely operate machines in your fleet.
...
- [view a machine's logs](/monitor/troubleshoot/#check-logs)
- [upload images from your phone to the cloud](/data/upload-other-data/#upload-images-with-the-viam-mobile-app)
- [invite people to collaborate with you and modify access](/monitor/teleoperate/#viam-mobile-app)

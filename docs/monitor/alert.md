...
To capture or alert on the data from your configured sensor, you must add the [data management service](/data/) and configure it to capture and sync the sensor data:

...
The dependency system ensures that your resource only starts after the resources it needs are available.

## Required vs optional dependencies

- **Required**: The resource cannot function without this dependency. `viam-server` will not start your resource until all required dependencies are running.
- **Optional**: The resource can function without this dependency. Your resource starts immediately, and `viam-server` retries the optional dependency every 5 seconds. When it becomes available, your resource reconfigures to pick it up.

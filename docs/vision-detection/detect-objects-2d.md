...
- [Classify Objects](/vision-detection/classify-objects/) -- use whole-image classification instead of per-object bounding boxes.
- [Track Objects Across Frames](/vision-detection/track-objects-across-frames/) -- maintain persistent identities for detected objects as they move between frames.
- [Localize Objects in 3D](/vision-detection/localize-objects-in-3d/) -- combine 2D detections with depth data to get real-world 3D positions.

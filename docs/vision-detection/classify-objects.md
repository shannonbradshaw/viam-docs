...
- [Detect Objects (2D)](/vision-detection/detect-objects-2d/) -- get per-object bounding boxes instead of whole-image labels.
- [Track Objects Across Frames](/vision-detection/track-objects-across-frames/) -- maintain object identities across consecutive frames.

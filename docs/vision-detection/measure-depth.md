...
- [Localize Objects in 3D](/vision-detection/localize-objects-in-3d/) -- project 2D detections into 3D space using the depth data from this how-to.
- [Detect Objects (2D)](/vision-detection/detect-objects-2d/) -- get 2D detections to combine with depth measurements.
- [Define Your Frame System](/work-cell-layout/define-your-frame-system/) -- understand how coordinate frames relate to each other when placing depth data in the context of your full robot.

...
1. Create an [API key](/manage/manage/api-keys/) for your organization, location, or machine.
...
The [Viam mobile app](/manage/troubleshoot/teleoperate/default-interface/#viam-mobile-app) lets you upload images directly from your phone, bypassing the normal capture and sync process.

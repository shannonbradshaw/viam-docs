---
linkTitle: "Track Objects Across Frames"
...
Detection gives you a snapshot: in this frame, there are three people. In the next frame, there are still three people. But are they the same three people? Tracking solves this by matching detections across consecutive frames and assigning stable IDs, so you can answer questions like: how long has this person been standing here? How many cars have passed through this intersection?
...
- [Localize Objects in 3D](/build/vision-detection/localize-objects-in-3d/) -- combine tracking with depth data to track objects in 3D space.
- [Count Objects](/build/stationary-vision/count-objects/) -- use tracking counts to build monitoring dashboards.
- [Trigger on Detection](/build/stationary-vision/trigger-on-detection/) -- trigger automated actions when tracked objects enter or exit a scene.

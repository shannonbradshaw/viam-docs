---
linkTitle: "Detect Objects (2D)"
title: "Detect Objects (2D)"
weight: 20
layout: "docs"
type: "docs"
...
- [Classify Objects](/build/vision-detection/classify-objects/) -- use whole-image classification instead of per-object bounding boxes.
- [Track Objects Across Frames](/build/vision-detection/track-objects-across-frames/) -- maintain persistent identities for detected objects as they move between frames.
- [Localize Objects in 3D](/build/vision-detection/localize-objects-in-3d/) -- combine 2D detections with depth data to get real-world 3D positions.

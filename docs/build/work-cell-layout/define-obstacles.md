...
- [Configure Robot Kinematics](/build/work-cell-layout/configure-robot-kinematics/) -- understand the
  kinematic model that the motion planner uses alongside obstacle definitions.
- [Calibrate Camera to Robot](/build/work-cell-layout/calibrate-camera-to-robot/) -- calibrate your

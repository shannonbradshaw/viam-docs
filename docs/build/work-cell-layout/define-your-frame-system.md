...
component's physical size. See [Define Obstacles](/build/work-cell-layout/define-obstacles/) for
...
- [Configure Robot Kinematics](/build/work-cell-layout/configure-robot-kinematics/) -- set up the
  kinematic model that describes how your arm's joints create motion.
- [Calibrate Camera to Robot](/build/work-cell-layout/calibrate-camera-to-robot/) -- determine your
  camera's intrinsic parameters for accurate 2D-to-3D projection.
- [Define Obstacles](/build/work-cell-layout/define-obstacles/) -- add collision geometry so the

...
| Direct MongoDB connection | Query via connection URI | On-demand | External tools, custom sync scripts |
...
- [Visualize Data](/build/data/visualize-data/) -- connect Grafana or other
  dashboard tools to your Viam data using the MongoDB connection URI.
- [Query Data](/build/data/query-data/) -- write advanced SQL and MQL queries

...
- [Query Data](/build/data/query-data/) -- learn more MQL patterns to use in
  your pipeline aggregation queries.
- [Filter at the Edge](/build/data/filter-at-the-edge/) -- reduce the volume of
  raw data before it reaches the cloud, making your pipelines faster and cheaper.
- [Visualize Data](/build/data/visualize-data/) -- build dashboards on top of

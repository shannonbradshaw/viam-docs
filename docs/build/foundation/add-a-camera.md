...
- [Capture and Sync Data](/build/foundation/capture-and-sync-data/) -- configure your camera to automatically capture images and sync them to the cloud.
- [Add Computer Vision](/build/vision-detection/add-computer-vision/) -- run ML models on your camera feed to detect or classify objects.

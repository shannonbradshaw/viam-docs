...
- [Add a Camera](/build/foundation/add-a-camera/) — Configure your first hardware component and
  see a live feed.
- [Capture and Sync Data](/build/foundation/capture-and-sync-data/) — Start recording data from

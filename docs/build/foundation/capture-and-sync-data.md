...
You can add multiple capture methods to a single component (e.g.,
...
- [Query Data](/build/data/query-data/) -- write more advanced queries, set up
  data pipelines, and export data.
- [Add Computer Vision](/build/vision-detection/add-computer-vision/) -- run ML
  models on your camera feed and capture detection results.
- [Create a Dataset](/build/train/create-a-dataset/) -- organize captured images

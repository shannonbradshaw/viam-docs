...
Get the kinematics information associated with the gripper as the format and byte contents of the [kinematics file](/reference/configuration/kinematic-chain-config/).
